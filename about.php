  ...
  <body cz-shortcut-listen="true">
    ...
    <div class="object-right">
      <ul class="list-inline">
        <li><a href="index.php">Web Partner SmartQuint</a></li>
      </ul>
    </div>
     <?php
    $today=date('m-d-Y');
    ...
    <section class="wrapper-hero" id="hero">
      ...
      <div class="container">
        <div class="row">
        <span class="text-box wow slideInDown" style="z-index:-1;font-size:18px;margin-top:8%;margin-left:35%;color: khaki;font-family:'hk_grotesk';visibility: visible; animation-name: slideInDown;">About Cygnus2K18</span>
</div>
...
<br>
          <div class="col-md-12">
            <div class="text-box wow slideInLeft" style="margin-top:13%;visibility: visible; animation-name: slideInLeft;">
              <p style="font-size:18px;">Cygnus2K18 is an Annual cultural extravaganza of IIIT Nuzvid. During the three-day event, students going to present a harmonious ensemble of the epic that sculpted morals and rich legacy of Indian traditions</p>
          </div>
