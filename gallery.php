...
<head>
  ...
  <body cz-shortcut-listen="true">
    ...
    <section class="wrapper-hero" id="hero">
      ...
      <div class="container">
        <div class="row">
        <span class="text-box wow slideInDown" style="z-index:-1;font-size:18px;margin-top:8%;margin-left:35%;color: khaki;font-family:'hk_grotesk';visibility: visible; animation-name: slideInDown;">Cygnus2K18 Gallery</span>
</div>
