   ...
   <?php include ("includes/topbar.php") ?>
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
       ...
       <?php
       $reg_users=mysql_num_rows(mysql_query("SELECT * FROM users "));
       $events=mysql_num_rows(mysql_query("SELECT * FROM events "));
       $not=mysql_num_rows(mysql_query("SELECT * FROM notifications "));  
       $org=mysql_num_rows(mysql_query("SELECT * FROM organizers ")); 
...
if($getuserdata['role']=="Webteam")
  ...
  <tbody>
    <tr><?php while($branch_cat=mysql_fetch_array($branches)){ echo "<td><div class='badge badge-primary'>".$branch_cat['displayname']."</div></td>"; }?></tr>
    </tbody>
    </table>
   <br>
...
echo "</tr><tr>";
    ...
    echo "<td><div class='badge badge-info'>".mysql_num_rows(mysql_query("SELECT * FROM events WHERE visibility='1' && branch='".$event_fet['branch']."'"))."
    </div></td>";
...
echo "</tr><tr>";
    ...
    echo "<td><div class='badge badge-danger'>".mysql_num_rows(mysql_query("SELECT * FROM organizers WHERE role='Organizer' && branch='".$event_fet['branch']."'"))."</div></td>";
...
<?php
  ...
  <tbody>
    <tr><?php while($branch_cat=mysql_fetch_array($settings)){ echo "<td><div class='badge badge-success'>".$branch_cat['function']."</div></td>"; }?></tr>
    
    <tr><?php 
      $settings=mysql_query("SELECT * FROM site_settings"); 
    while($branch_cat=mysql_fetch_array($settings)){ echo "<td><div class='badge badge-success'>".$branch_cat['value']."</div></td>"; }?></tr>
    </tbody>
    </table>
    <br>
...
echo "</tr><tr>";
    ...
    echo "<td><div class='badge badge-warning'>".mysql_num_rows(mysql_query("SELECT * FROM users WHERE year='".$event_fet['year']."'"))."</div></td>";
  ...
  <tbody>
    ...
    while( $branch_fet=mysql_fetch_array($branches))
     ...
     $branches=mysql_query("SELECT * FROM year_categories");
      while( $event_fet=mysql_fetch_array($branches))
        {            
    echo "<td><div class='badge badge-primary'>".mysql_num_rows(mysql_query("SELECT * FROM users WHERE year='".$event_fet['year']."' && paid='yes'"))."</div></td>";
  ...
  <tbody>
    ...
    <tr>
    <td><div class='badge badge-success'><?php echo mysql_num_rows(mysql_query("SELECT * FROM notifications"));?></div></td>
    <td><div class='badge badge-success'><?php echo mysql_num_rows(mysql_query("SELECT * FROM notifications WHERE visibility='1'"));?></div></td>
    <td><div class='badge badge-success'><?php echo mysql_num_rows(mysql_query("SELECT * FROM notifications WHERE visibility='0'"));?></div></td>
    <td><div class='badge badge-success'><?php echo mysql_num_rows(mysql_query("SELECT * FROM notifications WHERE visibility='1' && role='Webteam'"));?></div></td>
    <td><div class='badge badge-success'><?php echo mysql_num_rows(mysql_query("SELECT * FROM notifications WHERE visibility='1' && role='Organizer'"));?></div></td>
    <td><div class='badge badge-success'><?php echo mysql_num_rows(mysql_query("SELECT * FROM notifications WHERE visibility='0' && role='Webteam'"));?></div></td>
    <td><div class='badge badge-success'><?php echo mysql_num_rows(mysql_query("SELECT * FROM notifications WHERE visibility='0' && role='Organizer'"));?></div></td>
    </tr>                  
    </table>
  </tbody>
    <br>
...
<table class="table table-stripped table-bordered">
  ...
  while($upl_cat=mysql_fetch_array($upls)){ echo "  <tr>
