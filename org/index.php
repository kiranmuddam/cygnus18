...
$check=mysql_query("SELECT * FROM organizers WHERE orgid='$orgid'");
while($d=mysql_fetch_array($check)){
  $acc_status=$d['acc_status'];
}
if($acc_status=='Access'){
$dup=mysql_query("SELECT * FROM organizers WHERE orgid='$orgid' AND orgpass='$eorgpass'");
